...
int game_mainloop(int gamestate, clist_t *conns)
{
    switch (gamestate) {
        ...
        case GAME_OK:
            ...
            /* Synth hum */
            audio_play_synth(0, 0, 100.0, 0.9);
            audio_play_synth(0, 1, 150.0, 0.9);
            audio_play_synth(0, 2, 125.0, 0.9);
            audio_play_synth(0, 3, 175.0, 0.9);
            audio_play_synth(0, 4, 200.0, 0.05);
            audio_play_synth(0, 5, 300.0, 0.05);
            audio_play_synth(0, 6, 250.0, 0.05);
            audio_play_synth(0, 7, 350.0, 0.05);
        case GAME_OKING:
        ...
        case GAME_BREAK:
            ...
            /* Synth hum */
            audio_play_synth(0, 0,  80.0, 0.9);
            audio_play_synth(0, 1,  91.0, 0.9);
            audio_play_synth(0, 2, 120.5, 0.9);
            audio_play_synth(0, 3, 135.0, 0.9);
            audio_play_synth(0, 4, 155.0, 0.1);
            audio_play_synth(0, 5, 180.0, 0.1);
            audio_play_synth(0, 6, 199.0, 0.1);
            audio_play_synth(0, 7, 215.0, 0.1);
        case GAME_BREAKING:
